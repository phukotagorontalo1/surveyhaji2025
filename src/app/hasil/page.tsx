...
export default function HasilPage() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl text-center shadow-2xl animate-in fade-in zoom-in-95">
        <CardHeader>
        ...
        <CardContent className="px-8 pb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 bg-secondary/50 p-6 rounded-lg">
              ...
              <div className="text-center">
               ...
               <div className="text-center">
                  <h3 className="font-bold text-lg text-primary">Indeks Mobilisasi Haji (IMH)</h3>
                  <p className="font-headline text-5xl font-bold text-primary my-2">89.80</p>
                  <p className="font-bold text-green-600">Sangat Baik</p>
              </div>
          </div>
